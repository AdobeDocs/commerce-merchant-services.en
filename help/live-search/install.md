...
1. Wait at least an hour for the data to be indexed and synchronized. Then, use the [GraphQL playground](https://developer.adobe.com/commerce/webapi/graphql/schema/live-search/) with the default query to verify the following:
...
To update to a major version such as from 1.0.0 to 2.0.6, edit the project's root [!DNL Composer] `.json` file as follows:
