...
- Multi-word synonyms may not always work as expected. Please test these synonyms in the staging environment before using them in production, as they can potentially have an adverse effect on relevancy.
