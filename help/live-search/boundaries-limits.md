...
- [Special Pricing](https://experienceleague.adobe.com/en/docs/commerce-admin/catalog/products/pricing/product-price-special) is supported in the [!DNL Live Search] field and Product Listing Page Widget, however the start date and end date for the special pricing is not supported.
