...
- For [productSearch](https://developer.adobe.com/commerce/services/graphql/live-search/product-search/) query, [!DNL Live Search] and [!DNL Catalog Service] can return different results due to different caching strategies. You can alter this behavior by using a unified caching strategy on the client side.
