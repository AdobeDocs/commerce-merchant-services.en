...
- For [productSearch](https://developer.adobe.com/commerce/services/graphql/live-search/product-search/) query, Live Search and Catalog Service may return different results due to different caching strategies. This behavior can be altered by utilizing a unified caching strategy on the client side.
