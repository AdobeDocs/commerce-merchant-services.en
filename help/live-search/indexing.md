...
When [!DNL Live Search] is configured and synchronized during onboarding, it can take up to 30 minutes to build the initial index. Large catalogs may take a bit longer to index. The process begins after `cron` submits the feed and finishes running.
