...
![New](../assets/new.svg) [!DNL Live Search] now supports Multi-Source Inventory (MSI). To use MSI, you must [update](install.md#update) the `commerce-data-export` module to version 102.2.0+.
