...
Add your own curated list of [!DNL Live Search] synonyms to improve response to search requests and keep customers engaged. [!DNL Live Search] can manage up to 200 synonyms per `Data Space ID` / `Environment ID`.
