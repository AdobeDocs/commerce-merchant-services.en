...
![New](../assets/new.svg) [!DNL Product Recommendations] now supports Multi-Source Inventory (MSI). To use MSI, you must [update](install-configure.md#update) the `commerce-data-export` module to version 102.2.0+.
