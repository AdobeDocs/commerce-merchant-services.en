...
## [!DNL Product Recommendations] events

The following events are not specific to [!DNL Product Recommendations], but are required to return results:
...
If your storefront is implemented with PWA Studio, refer to the [PWA documentation](https://developer.adobe.com/commerce/pwa-studio/integrations/product-recommendations/). If you use a custom frontend technology such as React or Vue JS, refer to the user guide to learn how to integrate [[!DNL Product Recommendations] in a headless](headless.md) environment.
...
Headless implementations must implement eventing to power the [!DNL Product Recommendations] dashboard.
