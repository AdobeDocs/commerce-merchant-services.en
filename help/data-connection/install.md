...
1. (Optional) If you are a healthcare merchant, install the [data-services-hipaa](hipaa-readiness.md#installation) module so that your [!DNL Commerce] back office data is HIPAA-compliant.
