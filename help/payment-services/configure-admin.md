...
| [!UICONTROL Vault enabled in Admin] | store view | Enable or disable ability for merchant to complete orders for customers in the Admin using a vaulted payment method. Options: [!UICONTROL Yes] / [!UICONTROL No] |
